...
public class ModuleItem extends Item
{
    ...
    public ModuleItem(float powerMultiplier, int rank, int productivity, Properties properties)
    {
        super(properties);
        ...
        if (Screen.hasShiftDown())
        {
            ...
            if (this.productivity > 0)
            {
                components.add(productivity.withStyle(ChatFormatting.WHITE).append(
                        Component.literal(" " + this.productivity).withStyle(ChatFormatting.BLUE)));
            }
            if (this.rank > 0)
            {
            ...
            components.add(this.powerMultiplier < 1
                    ? multiplierDown.withStyle(ChatFormatting.WHITE).append(Component.literal(String.format(" %.1fx", powerMultiplier)).withStyle(ChatFormatting.GREEN))
