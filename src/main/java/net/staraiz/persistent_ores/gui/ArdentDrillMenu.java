...
import net.staraiz.persistent_ores.block.ArdentDrillBlock;
...
public class ArdentDrillMenu extends AbstractContainerMenu
{
    public final ArdentDrillBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ArdentDrillMenu(int id, Inventory playerInventory, FriendlyByteBuf extraData)
    {
            this(id, playerInventory, playerInventory.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ArdentDrillMenu(int id, Inventory playerInventory, BlockEntity entity, ContainerData data)
    {
        super(PersistentOresMenuTypes.ARDENT_DRILL_MENU.get(), id);
        checkContainerSize(playerInventory, 4);
        blockEntity = (ArdentDrillBlockEntity) entity;
